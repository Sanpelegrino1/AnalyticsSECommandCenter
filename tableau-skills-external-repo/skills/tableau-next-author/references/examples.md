# Tableau Next Visualization Examples

Real-world, production-quality examples extracted from actual Tableau Next deployments.
All examples use API `v66.0` with `minorVersion=12` on Tableau visualization and dashboard endpoints.
...
# 2. Create
curl POST .../tableau/visualizations?minorVersion=12 -d @viz.json
```
...
curl POST .../tableau/visualizations?minorVersion=12 -d @viz1.json
curl POST .../tableau/visualizations?minorVersion=12 -d @viz2.json

# 3. Create dashboard referencing those viz names
curl POST .../tableau/dashboards?minorVersion=12 -d @dashboard.json
```
