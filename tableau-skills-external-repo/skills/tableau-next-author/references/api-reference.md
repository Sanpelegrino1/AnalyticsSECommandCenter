...
**Important:** 
- Major version: `v66.0`
- Minor version: Use query parameter `?minorVersion=12` for Tableau visualization and dashboard endpoints.
...
**Endpoint:** `POST /tableau/visualizations?minorVersion=12`

**Request:**
```bash
curl -X POST \
  "https://{instance}.salesforce.com/services/data/v66.0/tableau/visualizations?minorVersion=12" \
  -H "Authorization: Bearer {access_token}" \
  -H "Content-Type: application/json" \
  -d '{
...
**Endpoint:** `POST /tableau/dashboards?minorVersion=12`

**Request:**
```bash
curl -X POST \
  "https://{instance}.salesforce.com/services/data/v66.0/tableau/dashboards?minorVersion=12" \
  -H "Authorization: Bearer {access_token}" \
  -H "Content-Type: application/json" \
  -d @dashboard.json
```
...
**Endpoint:** `GET /tableau/visualizations/{visualizationIdOrApiName}?minorVersion=12`

**Request:**
```bash
curl -X GET \
  "https://{instance}.salesforce.com/services/data/v66.0/tableau/visualizations/Revenue_by_Region?minorVersion=12" \
  -H "Authorization: Bearer {access_token}"
```
...
**Endpoint:** `PATCH /tableau/visualizations/{visualizationIdOrApiName}?minorVersion=12`
...
**Endpoint:** `DELETE /tableau/visualizations/{visualizationIdOrApiName}?minorVersion=12`
...
```bash
curl -X POST \
  "https://myorg.salesforce.com/services/data/v66.0/tableau/visualizations?minorVersion=12" \
  -H "Authorization: Bearer 00Dxx0000000001!..." \
  -H "Content-Type: application/json" \
...
```bash
curl -X GET \
  "https://myorg.salesforce.com/services/data/v66.0/tableau/visualizations/Revenue_by_Region?minorVersion=12" \
  -H "Authorization: Bearer 00Dxx0000000001!..."
```
